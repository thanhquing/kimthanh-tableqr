...
| `SA-00`…`SA-14` | Production SaaS: đa quán, đăng ký, trial và billing | M8–M11 / Release | **IN PROGRESS** — M8 `SA-03`…`SA-07`, policy `SA-01`, lifecycle `SA-08`, payment adapter `SA-09`, billing UI `SA-10` và enforcement `SA-11` đã xong local; tiếp theo `SA-12` (vận hành/nghiệm thu billing) rồi `SA-13`. `SA-00`, `SA-02`, `BE-13` là cổng DevOps/phát hành cuối. Chi tiết [13-saas-expansion.md](13-saas-expansion.md) |
