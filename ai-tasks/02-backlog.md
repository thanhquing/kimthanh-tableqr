...
| `SA-00`…`SA-14` | Production SaaS: đa quán, đăng ký, trial và billing | M8–M11 / Release | **IN PROGRESS** — đang hoàn tất `SA-03`/`SA-04` RLS local; `SA-00`, `SA-02`, `BE-13` được dời thành cổng DevOps/phát hành cuối. Chi tiết [13-saas-expansion.md](13-saas-expansion.md) |
