...
| `SA-00`…`SA-14` | Production SaaS: đa quán, đăng ký, trial và billing | M8–M11 / Release | **IN PROGRESS** — M8 `SA-03`…`SA-07` đã xong local; tiếp theo `SA-01` cần quyết định chính sách billing trước khi làm lifecycle. `SA-00`, `SA-02`, `BE-13` là cổng DevOps/phát hành cuối. Chi tiết [13-saas-expansion.md](13-saas-expansion.md) |
