...
| `SA-00`…`SA-14` | Production SaaS: đa quán, đăng ký, trial và billing | M8–M11 / Release | **IN PROGRESS** — `SA-03`…`SA-06` tenant foundation/onboarding API đã xong; tiếp theo `SA-07` SaaS admin shell. `SA-00`, `SA-02`, `BE-13` là cổng DevOps/phát hành cuối. Chi tiết [13-saas-expansion.md](13-saas-expansion.md) |
