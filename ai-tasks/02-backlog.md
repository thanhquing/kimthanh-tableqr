...
| `SA-00`…`SA-14` | Production SaaS: đa quán, đăng ký, trial và billing | M8–M11 / Release | **IN PROGRESS** — M8 `SA-03`…`SA-07`, policy `SA-01` và lifecycle `SA-08` đã xong local; tiếp theo `SA-09` tạo provider adapter generic và cần chọn implementation theo quốc gia. `SA-00`, `SA-02`, `BE-13` là cổng DevOps/phát hành cuối. Chi tiết [13-saas-expansion.md](13-saas-expansion.md) |
