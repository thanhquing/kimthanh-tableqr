...
>
> Chi tiết đầy đủ: [07-admin-task-list.md § AD-05](07-admin-task-list.md)
>
...
>
> **Xong khi:** danh sách bàn CRUD hoạt động, hiện lỗi 409 hợp đồng và không có cách đổi QR token.
...
`AD-05`…`AD-08` → `WS-05`…`WS-07` → **cổng M5→M6** → `BE-*`.
